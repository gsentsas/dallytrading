...
import { appointmentRescheduleRequest, rescheduleAppointment } from '@/lib/ops/appointments';
...
export async function POST(request: Request, { params }: {
  ...
  return reponseMutation({
    ...
    lireSession: readOpsSession, schema: appointmentRescheduleRequest,
    evenement: 'ops.appointments.reschedule',
    executer: (body, session) => rescheduleAppointment(
      reference.data, body, session, correlation),
  });
}
