    ...
    def test_les_capacites_sont_des_verbes_metier(self):
        ...
        self.assertEqual(
            ...
            {"intake_create", "intake_search", "intake_state_advance",
             ...
             "appointment_manage", "photo_manage", "event_create",
             "consolidation_load", "supervise"})
        ...
        self.assertTrue(capacites["event_create"])
        self.assertTrue(capacites["consolidation_load"])
